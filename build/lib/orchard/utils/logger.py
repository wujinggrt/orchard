...
class LogManager:
    ...
    def __init__(self):
        ...
        self.configure(config=get_config(dot_path="logging"))
    ...
    def configure(self, *, config: dict[str, Any]) -> None:
        ...
        Args:
            config (dict[str, Any]): Logging configuration. Maybe involve "level" and "log_path".
        """
        logger.remove()
        ...
        if log_path:
            ...
            dated_log_path = os.path.join(
                log_dir, f"{name_without_ext}_{{time:YYYY-MM-DD}}{ext}"
            )
